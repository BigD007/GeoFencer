    ...
    using GeoFencer.Droid.Services.Geofences;
	...
	[assembly: Xamarin.Forms.Dependency(typeof(GeoFencer.Droid.Services.Geofences.GeofencesService))]

namespace GeoFencer.Droid.Services.Geofences
{ 
	public class GeofencesService : IGeofencesService
	{
		...
		//void IGeofencesService.SetGeofences(List<Position> targets, Position currentPosition)
		//{
